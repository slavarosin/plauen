									...
									<tbody>
										<tr>
											<td colspan="2" align="center" valign="top">
												<table width="80%" border="0" cellpadding="0" cellspacing="0">
													...
													<tr bgcolor="#687B83">
														<td>&nbsp;</td>
														<td align="center" bgcolor="#687B83" class="HeaderBIG"><fmt:message key="game.create.page.title" /></td>
														<td>&nbsp;</td>
													</tr>
													<tr>
												...
												<fieldset>
													...
													<table width="100%" cellpadding="0" cellspacing="0" border="0">
														...
														<tbody>
															...
															<tr>
																<td class="usertable">
																	<fmt:message key="game.create.image.1.label" />
																</td>
																<td align="left" class="usertable">
															...
															<tr>
																<td class="usertable">
																	<fmt:message key="game.create.image.2.label" />
																</td>
																<td align="left" class="usertable">
															...
															<tr>
																<td class="usertable">
																	<fmt:message key="game.create.image.3.label" />
																</td>
																<td align="left" class="usertable">
										...
										<tr>
											<td colspan="2" align="center">
												...
												<span class="button_s2_text"><fmt:message key='game.create.submit' /></span></div>
												</div>
											</td>
										</tr>
									</tbody>
