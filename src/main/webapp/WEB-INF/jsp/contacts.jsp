								...
								<tr>
									...
									<table border="0" cellpadding="0" cellspacing="0" width="80%">
										<tbody>
											...
											<tr bgcolor="#687b83">
												<td>&nbsp;</td>
												<td class="HeaderBIG" align="center" bgcolor="#687b83"><div class="white"><fmt:message key="contacts.title" /></div></td>
												<td>&nbsp;</td>
											</tr>
											<tr>
											...
											<tr>
												...
												<td>
												    ...
												    <p class="MainText" style="color:black; text-align: justify;">
                                                        <c:import url="contacts/textOfContacts_${locale.language}.jsp"/>
                                                    </p>
												</td>
												<td>&nbsp;</td>
											</tr>
